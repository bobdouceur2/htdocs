...
$query_projets = "SELECT ID, Intitule FROM projets";
$result_projets = $conn->query($query_projets);
$projets = [];
if ($result_projets) {
...
<!-- Popup Form pour Ajouter un Nouveau Projet -->
<div id="popupForm" class="popup-form">
    <div class="popup-content">
        ...
        <form id="addRowForm" class="form-container">
            ...
            <button type="button" onclick="addRow()" class="btn btn-primary">Ajouter un nouveau Projet</button>
        </form>
...
<div id="editPopupForm" class="popup-form">
    <div class="popup-content">
        ...
        <form id="editRowForm" class="form-container">
            ...
            <button type="button" onclick="saveEditedRow()" class="btn btn-primary">Sauvegarder</button>
        </form>
    </div>
</div>
...
<!-- Popup Form pour l'Upload de Fichier -->
<div id="uploadPopupForm" class="popup-form">
    <div class="popup-content">
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data" class="form-container">
            ...
            <label for="projet_id">Lier à un projet :</label>
            <select name="projet_id" id="projet_id" required>
                <option value="">Sélectionnez un projet</option>
                <?php foreach ($projets as $projet): ?>
                    <option value="<?php echo $projet['ID']; ?>"><?php echo htmlspecialchars($projet['Intitule']); ?></option>
                <?php endforeach; ?>
            </select>

            <label for="note">Note :</label>
            <textarea name="note" id="note" rows="4" placeholder="Ajoutez une note ou un détail sur le fichier..." style="width: 100%;"></textarea>
