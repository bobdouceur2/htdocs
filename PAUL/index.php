...
<head>
    ...
    <style>
        ...
        #logoSafran {
            ...
            left: 20px;
            z-index: 1100;
            width: 150px; /* Ajustez cette valeur pour réduire la largeur du logo */
            height: auto; /* Cette propriété conserve le ratio d'aspect */
        }
...
<body>
    ...
    <img src="safran_logo.png" alt="Logo Safran" id="logoSafran" />
